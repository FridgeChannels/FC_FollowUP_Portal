...
export function WorkspaceProvider({ children }: { children: React.ReactNode }) {
  ...
  const value:Store={state,hydrated,can,reset,setRole,advanceDay,launchBomb,receiveReply,sendHumanReply,changeCP,createFollowUp,resolveInbox,pauseBrand,assignBrand,createCallTask,createBrand,importBrands,updateContact,closeBrand,reassignCall,updateCallerCapacity,saveBomb,createBomb,setBombStatus,updateCPStage,updateIntegration,fillTodayCapacity,simulateFailure};
