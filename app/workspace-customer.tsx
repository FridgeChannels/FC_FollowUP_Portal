...
const IcpGroup=({value}:{value:string})=><Badge variant="outline" className="rounded-md bg-emerald-50 font-mono text-[11px] font-bold text-emerald-800">{value}</Badge>;
