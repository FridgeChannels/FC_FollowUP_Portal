...
export function createSeedState(): WorkspaceState {
  ...
  const customers: Customer[] = [
    ...
    {id:"c_cedar",name:"Cedar & Salt",initials:"CS",cp:"CP0",status:"Human Handling",source:"Website",ownerId:"u_mike",contacts:[{id:"ct_cedar_jamie",name:"Jamie Park",role:"Other",email:"jamie@cedarandsalt.com",phone:"+1 617 555 0186",linkedin:"jamie-park",preferredChannel:"LinkedIn",emailValid:true,phoneValid:true}],createdAt:addDays(today,-4),updatedAt:addDays(today,-0.08)},
  ];
